...
const projects = [
  ...
  {
    id: 2,
    title: "AI-Integrated Academic & Certificate Management System",
    description: " Built a unified web platform for students, teachers, and administrators with real-time academic and co-curricular dashboards, including faculty validation and AI-powered certificate verification.",
  ...
  {
    id: 3,
    title: "Cafe Preordering system",
    description: "The Cafe Pre-Delivery System with modern UI/UX, authentication, add-to-cart system integrated on it, and the analysis system for the admin is on the production level. ",
    image: "/Intro/Tausif/Tech.png",
    github: "https://github.com/tausif-lab/Tech-Cafe",
    demo: "https://tech-cafe-codex.vercel.app",
