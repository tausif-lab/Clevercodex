...
const currentFrame = (index: number) =>
  `/Sourabh-jpg/ezgif-frame-${index.toString().padStart(3, "0")}.jpg`;

export function ImageScrollSourabh() {
  ...
  const crewName = "3.Zoro "; // Subheading on top of the frame
  const name = "Sourabh Chandrakar";
  const title = "Backend Developer and Market Researcher";
